...
def main_worker(args):
    ...
    # Trainer
    # print('=======================', args.Lambda1, args.Lambda2, '==============================================')
    trainer = ClusterContrastTrainer(model, args=args)
    # Lambda1 = args.Lambda1, Lambda2 = args.Lambda2, nncl = args.nncl, rcl = args.rcl, gcr = args.gcr, k = args.k_knn
...
if __name__ == '__main__':
    ...
    # data
    parser.add_argument('-d', '--dataset', type=str, default='msmt',
    ...
    # model
    parser.add_argument('-a', '--arch', type=str, default='vit_small', choices=models.names())  # vit_small
    parser.add_argument('-pp', '--pretrained-path', type=str, default='/home/a/data/hqs_2023_v3/vit_small_cfs_lup.pth')
    parser.add_argument('--resume', type=str,
                        default="/home/a/data/hqs_2023_v3/code5/cluster-contrast-reid-v2/log_base_msmt/checkpoint30.pth.tar",
                        metavar='PATH')
    ...
    parser.add_argument('--data-dir', type=str, metavar='PATH', default='/home/a/data/hqs/reid_data')
    parser.add_argument('--logs-dir', type=str, metavar='PATH', default=osp.join(working_dir, 'log_msmt_1'))
